...
proc sort data=work.Paints;
  by bright;
run;

data work.PaintsBlockedRoad;
  input road $ 1-12 paint 13-14  bright 15-16;
  datalines;
Broadway    1 48
Main St.    1 49
...
proc sort data=work.PaintsBlockedRoad;
  by bright;
run;

data work.RiseCereal;
  input brand $ 1-15 @16 weight 7.4 idnumber 24-31;
  datalines;
Rise n Shine   15.0136 33081197
Rise n Shine   14.9982 37070397
